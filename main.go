...
import (
	...
	_ "github.com/FloatTech/ZeroBot-Plugin/plugin/score"         // 签到分数
...
func init() {
	...
	// 默认昵称
	adana := flag.String("n", "灰风", "Set default nickname.")
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "灰风", "灰风老婆"),
